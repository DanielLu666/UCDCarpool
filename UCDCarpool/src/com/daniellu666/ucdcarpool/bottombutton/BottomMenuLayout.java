...
import com.daniellu666.ucdcarpool.*;/** 注意这里**/
...
public class BottomMenuLayout extends LinearLayout {
	 ...
	 * 该值需要根据按钮背景图片来调整。
	 */
	public static final int bottom_layoutHeight = 180;
	...
	private void bindingButton() {
		...
		buttonFrameInstance.setOnClickListener(new View.OnClickListener() {
			...
			{
				v.getContext().startActivity(new Intent(v.getContext(),CarpoolItemActivity.class));
			}
		});
	}
